...
const translations = {
  en: {
    ...
    notificationsBlocked: "Notifications blocked. Enable them in your browser settings.",
  ...
  pt: {
    ...
    notificationsBlocked: "Notificações bloqueadas. Ative-as nas configurações do navegador.",
